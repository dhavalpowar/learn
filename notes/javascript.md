...
* Functions
    ...
    - In Javascript, everything is function scoped.
...
- The event object
    ...
    + Event bubbling and capture
        ...
        - Fixing the problem with `e.stopPropagation()`
    + See also:
...
* Prototypes
    ...
    - `Object.create(obj)` attaches prototype of obj to the prototype of the new object.
    - The `constructor` property
        + constructor function has a prototype property
        + This constructor property points to the original constructor function.
        +  available to all the instance objects created using the Person() constructor
...
* Prototypal Inheritance
    - Super class's constructor function called from the child constructor function using `call()` For eg.
        ```javascript
    ...
    - Setting Teacher()'s prototype and constructor reference - Set subclass' prototype as:
        ```javascript
